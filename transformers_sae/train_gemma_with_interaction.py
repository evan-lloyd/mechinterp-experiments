...
training_results = train(
    ...
    checkpoint_dir="/workspace/sae_checkpoints/gemma_2_2b/next_layer_interaction/",
    force_retrain=False,
)
...
print(
    f"live features={ {k: sum(v.live_features) / D_SAE_INTERACTION for k, v in validations.layer_results.items() if v.live_features is not None} }"
)
